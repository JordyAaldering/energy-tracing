...
fn advance(bodies: &mut [Body; 5], dt: f64, steps: i32) {
    for _ in 0..steps {
        trace_region!("timestep", {
...
fn mechanical_energy(bodies: &[Body; 5]) -> f64 {
    let mut e = 0.0;
